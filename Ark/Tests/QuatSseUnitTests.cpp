/*************************************************************************
 * @file
 * @brief Quat SSE-optimized Implementation Unit Tests
 *
 * @details Unit tests for the SSE-optimized Quat class implementations.
...
//  Configuration
//************************************************************************
#define QUAT_TEST_NAMESPACE quat_sse_unit_tests
#define QUAT_TEST_CLASS QuatSseUnitTest
